# Script para aplicar el commit08 - Panel de administración
# Ejecutar en PowerShell desde la raíz del repositorio

Write-Host "Aplicando commit08 - Panel de administración..." -ForegroundColor Green

# Crear src/pages/DashboardProducts.jsx
@"
...
"@ | Out-File -FilePath "src/pages/DashboardProducts.jsx" -Encoding UTF8

# Crear src/pages/ProductForm.jsx
@"
...
"@ | Out-File -FilePath "src/pages/ProductForm.jsx" -Encoding UTF8
...
"@ | Out-File -FilePath "src/router.jsx" -Encoding UTF8

Write-Host "✅ Commit08 aplicado exitosamente!" -ForegroundColor Green
Write-Host "Ahora puedes hacer: git add . && git commit -F tpo-commits/commit08/commit-message.txt" -ForegroundColor Yellow
