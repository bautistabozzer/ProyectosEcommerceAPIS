# Script para aplicar el commit06 - Autenticación y rutas protegidas
# Ejecutar en PowerShell desde la raíz del repositorio

Write-Host "Aplicando commit06 - Autenticación y rutas protegidas..." -ForegroundColor Green
...
"@ | Out-File -FilePath "src/pages/Login.jsx" -Encoding UTF8
...
"@ | Out-File -FilePath "src/pages/Register.jsx" -Encoding UTF8
...
"@ | Out-File -FilePath "src/components/ProtectedRoute.jsx" -Encoding UTF8

Write-Host "✅ Commit06 aplicado exitosamente!" -ForegroundColor Green
Write-Host "Ahora puedes hacer: git add . && git commit -F tpo-commits/commit06/commit-message.txt" -ForegroundColor Yellow
