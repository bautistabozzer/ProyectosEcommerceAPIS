# Script para aplicar el commit07 - Catálogo y productos
# Ejecutar en PowerShell desde la raíz del repositorio

Write-Host "Aplicando commit07 - Catálogo y productos..." -ForegroundColor Green

# Crear src/pages/Home.jsx (primera parte)
@"
...
Write-Host "✅ Commit07 aplicado exitosamente!" -ForegroundColor Green
